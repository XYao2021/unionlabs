...
garbage >10%).
    ...
    python3 ber_dist.py QPSK=../experiments/marl_ra/results/ber_cmp_QPSK.csv \
                        DQPSK=../experiments/marl_ra/results/ber_cmp_DQPSK.csv
...
DEFAULT_OUT = os.path.abspath(os.path.join(
    os.path.dirname(__file__), "..", "marl_multi", "results"))
