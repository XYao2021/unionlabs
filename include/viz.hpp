...
//    viz/tx_symbols.txt   modulated symbols (TX constellation)
//    viz/tx_wave.txt      transmitted baseband waveform (time domain)
//    viz/rx_wave.txt      received burst after AGC (time domain)
//    viz/rx_symbols.txt   equalized symbols before demod (RX constellation)
