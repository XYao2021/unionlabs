...
|---|---|---|---|---|
| 1. Reliable link — **MARL / OSU** | `MARL_RA_Union/`, `python/` | yes | yes | yes (needs ≥3 USRP for real collisions) |
...
equations and on a synchronized 2-channel RX capture). See `STC_AirComp_Union/INTEGRATION.md`.
...
and `applications/APPLICATIONS_INTRO.pdf`.
