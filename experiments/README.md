# `experiments/` — everything you run lives here
...
and docs belong to it. Put yours in `experiments/<name>/app.py` as a plain object that says
...
Environment knobs for the learning algorithms (defaults mirror `experiments/_shared/fl.py`):
