...
policy networks and update rule the full stack uses (`marl_learning` + `marl_train.py`),
...
Reuses the REAL networks from experiments/marl_ra/marl_learning.py. Needs torch.
...
from marl_learning import actor_MLP, critic_MLP          # the REAL policy nets  # noqa: E402

DIM_O, DIM_A, WIDTH, DEPTH = 3, 2, 64, 2          # obs=[AoI,queue,busy], actions={defer,transmit}
GAMMA, LR, CLIP = 0.9, 4e-4, 10.0                 # match experiments/marl_ra
