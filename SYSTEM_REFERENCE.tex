...
stands alone in the repo as \texttt{COMMANDS.md}.
...
\hypertarget{unlocking-16-qam-and-higher--the-cabled-link}{%
\subsubsection{Unlocking 16-QAM and higher --- the cabled
link}\label{unlocking-16-qam-and-higher--the-cabled-link}}

Cable the two radios (SMA + \textasciitilde30--40 dB attenuator) for a
clean, flat channel: EVM drops well below 10 \%, so \textbf{16-QAM /
64-QAM / 256-QAM} single-carrier decode. Start from
\texttt{-\/-rx-gain\ 21\ -\/-tx-gain\ 80} and lower \texttt{-\/-rx-gain}
/ add attenuation until the raw RX front end isn't saturated; keep
\texttt{-\/-fec\ true}. Higher orders need progressively lower EVM
(16-QAM \textless\textasciitilde{} 12 \%, 64-QAM
\textless\textasciitilde{} 6 \%, 256-QAM \textless\textasciitilde{} 3
\%).
