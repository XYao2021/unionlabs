...
\item
  ...
  actually sees; non-zero here ⇒ CRC fails.
\end{itemize}
...
\texttt{pre-FEC\ 24\%}, \texttt{post-FEC\ 42\%} (≈ random ⇒ genuine
garbage). The processing gain of the preamble correlation means a burst
can \textbf{detect strongly yet decode to garbage} (detection ≠
decodability).
